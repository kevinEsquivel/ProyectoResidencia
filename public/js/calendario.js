...
/*!MODAL */ 
const _modalTitle = document.querySelector("#nombreTarea");
const _modal_dateStart = document.querySelector("#date_start");
const _modal_dateEnd = document.querySelector("#date_end");
const _modal_description = document.querySelector("#descripcion");
const btn_guardar = document.querySelector("#btnGuardarModal");
...
class Card {
  ...
  renderItems() {
    ...
    for (let _item of this.items) {
      ...
      //!Modificacion
      _newItemEditButton.dataset.bsToggle = "modal";
      _newItemEditButton.dataset.bsTarget = "#exampleModal";
